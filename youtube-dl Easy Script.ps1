...
$downloader_exe="youtube-dl.exe" # "yt-dlp.exe"  or  "youtube-dl.exe"
...
& .\$downloader_exe $format $URL '--%' $options #Final full command used on youtube-dl. I have no idea why '--%' is required in there but without it, it won't work. Got it from an obscure StackOverflow comment
cmd /c pause
